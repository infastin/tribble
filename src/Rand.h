...
/* @brief SplitMix64 - a fast, high-quality seudorandom number generator.
 *        Recommended for initializing generators of the xoshiro familiy from a 64-bit seed.
 * @details https://prng.di.unimi.it/
 */
...
/**
 * @brief xoshiro128** - all-purpose, rock-solid generator.
...
/**
 * @brief xoshiro128+ - best and fastest 32-bit generator for 32-bit floating-point numbers.
...
/**
 * @brief xoshiro256** - all-purpose, rock-solid generator.
...
/**
 * @details xoshiro256+ - best and fastest generator for floating-point numbers.
