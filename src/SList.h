 ...
 */
uint slist_len(const SList *list);
 ...
 */
SList *slist_nth(SList *list, uint n);
 ...
 */
uint slist_position(SList *list, SList *node);
 ...
 * @return 0 on success
 */
int slist_copy(SList *dst, const SList *src, CopyFunc copy_func);
